...
var tinhToan = function(){
    ...
    // (Required) Đặt điều kiện yêu cầu nhập đầy đủ các thông tin
    if (document.getElementById("tien-vay").value == "") {
        alert("Error! \nVui lòng nhập số tiền muốn vay.")
    } else if (document.getElementById("time").value == "") {
        alert("Error! \nVui lòng nhập thời gian vay.")
    } else if (document.getElementById("lai-suat").value == "") {
